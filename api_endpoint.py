...
app = FastAPI(title="API Endpoint", version="AGJ",
              description="An API Endpoint designed to get the Latitude & Longitude value of the given Address. This API accepts 'address' and 'output_format' parameters value in a given format and returns the Latitude & Longitude value in a XML or JSON format.",
              contact={
    "name": "Akshay G J",
    "url": "https://www.linkedin.com/in/akshay-gj",
    "email": "akshaygj001@gmail.com",
}, docs_url="/")
...
def get_data(address: str, output_format: str) -> Response:
...
def get_latNlong(params: AddressDetailsParameters) -> Response:
    ...
    """
    params = params.dict()
    return get_data(address=params["address"], output_format=params["output_format"])
